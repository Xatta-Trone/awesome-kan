...
## Last Updated
September 24, 2026 at 02:06:21 AM UTC
...
- [Towards Deep Physics-Informed Kolmogorov-Arnold Networks](https://arxiv.org/abs/2510.23501)
...
- [Kolmogorov-Arnold Energy Models: Fast and Interpretable Generative Modeling](https://arxiv.org/abs/2506.14167)
...
- [A Hybrid CNN-Cheby-KAN Framework for Efficient Prediction of Two-Dimensional Airfoil Pressure Distribution](https://arxiv.org/abs/2511.03223)
- [Hybrid DeepONet Surrogates for Multiphase Flow in Porous Media](https://arxiv.org/abs/2511.02962)
...
- [Physics-informed Machine Learning for Static Friction Modeling in Robotic Manipulators Based on Kolmogorov-Arnold Networks](https://arxiv.org/abs/2511.10079)
- [BubbleOKAN: A Physics-Informed Interpretable Neural Operator for High-Frequency Bubble Dynamics](https://arxiv.org/abs/2508.03965)
- [The modified Physics-Informed Hybrid Parallel Kolmogorov--Arnold and Multilayer Perceptron Architecture with domain decomposition](https://arxiv.org/abs/2511.11228)
- [Learning Implicit Neural Degradation Representation for Unpaired Image Dehazing](https://arxiv.org/abs/2511.13110)
- [Catastrophic Forgetting in Kolmogorov-Arnold Networks](https://arxiv.org/abs/2511.12828)
...
- [TK-Mamba: Marrying KAN With Mamba for Text-Driven 3D Medical Image Segmentation](https://arxiv.org/abs/2505.18525)
- [Scale-Agnostic Kolmogorov-Arnold Geometry in Neural Networks](https://arxiv.org/abs/2511.21626)
- [SUPN: Shallow Universal Polynomial Networks](https://arxiv.org/abs/2511.21414)
- [Enhancing Burmese News Classification with Kolmogorov-Arnold Network Head Fine-tuning](https://arxiv.org/abs/2511.21081)
...
- [DB-KAUNet: An Adaptive Dual Branch Kolmogorov-Arnold UNet for Retinal Vessel Segmentation](https://arxiv.org/abs/2512.01657)
- [Scalable and Interpretable Scientific Discovery via Sparse Variational Gaussian Process Kolmogorov-Arnold Networks (SVGP KAN)](https://arxiv.org/abs/2512.00260)
- [KAN-SAs: Efficient Acceleration of Kolmogorov-Arnold Networks on Systolic Arrays](https://arxiv.org/abs/2512.00055)
- [Assessing the performance of correlation-based multi-fidelity neural emulators](https://arxiv.org/abs/2512.02868)
- [Symbolic Learning of Topological Bands in Photonic Crystals](https://arxiv.org/abs/2505.10485)
- [QKAN-LSTM: Quantum-inspired Kolmogorov-Arnold Long Short-term Memory](https://arxiv.org/abs/2512.05049)
- [KANFormer for Predicting Fill Probabilities via Survival Analysis in Limit Order Books](https://arxiv.org/abs/2512.05734)
- [The T12 System for AudioMOS Challenge 2025: Audio Aesthetics Score Prediction System Using KAN- and VERSA-based Models](https://arxiv.org/abs/2512.05592)
- [Uncertainty Quantification for Scientific Machine Learning using Sparse Variational Gaussian Process Kolmogorov-Arnold Networks (SVGP KAN)](https://arxiv.org/abs/2512.05306)
- [Trapped Fermions Through Kolmogorov-Arnold Wavefunctions](https://arxiv.org/abs/2512.07800)
- [KAN-Dreamer: Benchmarking Kolmogorov-Arnold Networks as Function Approximators in World Models](https://arxiv.org/abs/2512.07437)
...
- [Entanglement Witness Derived By Using Kolmogorov-Arnold Networks](https://arxiv.org/abs/2512.06298)
- [Softly Symbolifying Kolmogorov-Arnold Networks](https://arxiv.org/abs/2512.07875)
- [GS-KAN: Parameter-Efficient Kolmogorov-Arnold Networks via Sprecher-Type Shared Basis Functions](https://arxiv.org/abs/2512.09084)
...
- [KAN-Matrix: Visualizing Nonlinear Pairwise and Multivariate Contributions for Physical Insight](https://arxiv.org/abs/2512.15755)
- [SHARe-KAN: Holographic Vector Quantization for Memory-Bound Inference](https://arxiv.org/abs/2512.15742)
- [MINPO: Memory-Informed Neural Pseudo-Operator to Resolve Nonlocal Spatiotemporal Dynamics](https://arxiv.org/abs/2512.17273)
- [Training Deep Physics-Informed Kolmogorov-Arnold Networks](https://arxiv.org/abs/2510.23501)
- [Deep Legendre Transform](https://arxiv.org/abs/2512.19649)
- [Kolmogorov-Arnold Graph Neural Networks Applied to Inorganic Nanomaterials Dataset](https://arxiv.org/abs/2512.19494)
- [Sprecher Networks: A Parameter-Efficient Kolmogorov-Arnold Architecture](https://arxiv.org/abs/2512.19367)
- [Merging of Kolmogorov-Arnold networks trained on disjoint datasets](https://arxiv.org/abs/2512.18921)
- [KAN-AFT: An Interpretable Nonlinear Survival Model Integrating Kolmogorov-Arnold Networks with Accelerated Failure Time Analysis](https://arxiv.org/abs/2512.20305)
- [DecoKAN: Interpretable Decomposition for Forecasting Cryptocurrency Market Dynamics](https://arxiv.org/abs/2512.20028)
- [From GNNs to Symbolic Surrogates via Kolmogorov-Arnold Networks for Delay Prediction](https://arxiv.org/abs/2512.20885)
- [Fully analogue in-memory neural computing via quantum tunneling effect](https://arxiv.org/abs/2510.23638)
- [Lyapunov-Based Kolmogorov-Arnold Network (KAN) Adaptive Control](https://arxiv.org/abs/2512.21437)
- [KANO: Kolmogorov-Arnold Neural Operator for Image Super-Resolution](https://arxiv.org/abs/2512.22822)
- [Uncertainty-Aware Flow Field Reconstruction Using SVGP Kolmogorov-Arnold Networks](https://arxiv.org/abs/2512.22426)
- [Integrating Wide and Deep Neural Networks with Squeeze-and-Excitation Blocks for Multi-Target Property Prediction in Additively Manufactured Fiber Reinforced Composites](https://arxiv.org/abs/2512.22397)
...
- [ABFR-KAN: Kolmogorov-Arnold Networks for Functional Brain Analysis](https://arxiv.org/abs/2601.00416)
...
- [Resonant fragility and nonresonant robustness of Floquet eigenstates in kicked spin systems](https://arxiv.org/abs/2504.13257)
- [Kolmogorov Arnold Networks and Multi-Layer Perceptrons: A Paradigm Shift in Neural Modelling](https://arxiv.org/abs/2601.10563)
...
- [Numerical simulation and analysis of mixing enhancement due to chaotic advection using an adaptive approach for approximating the dilution index](https://arxiv.org/abs/2408.05055)
- [Kolmogorov-Arnold Networks Applied to Materials Property Prediction](https://arxiv.org/abs/2601.20097)
- [Vision KAN: Towards an Attention-Free Backbone for Vision with Kolmogorov-Arnold Networks](https://arxiv.org/abs/2601.21541)
...
- [Realistic Face Reconstruction from Facial Embeddings via Diffusion Models](https://arxiv.org/abs/2602.13168)
...
- [BiKA: Kolmogorov-Arnold-Network-inspired Ultra Lightweight Neural Network Hardware Accelerator](https://arxiv.org/abs/2602.23455)
- [VIKIN: A Reconfigurable Accelerator for KANs and MLPs with Two-Stage Sparsity Support](https://arxiv.org/abs/2603.01165)
- [TokenCom: Vision-Language Model for Multimodal and Multitask Token Communications](https://arxiv.org/abs/2603.00482)
- [DKD-KAN: A Lightweight knowledge-distilled KAN intrusion detection framework, based on MLP and KAN](https://arxiv.org/abs/2603.03486)
- [Merged amplitude encoding for Chebyshev quantum Kolmogorov--Arnold networks: trading qubits for circuit executions](https://arxiv.org/abs/2603.02818)
- [Invariant Curves and the Variational Structure in Tubular Origami Dynamical Systems](https://arxiv.org/abs/2603.02410)
...
- [Light-ResKAN: A Parameter-Sharing Lightweight KAN with Gram Polynomials for Efficient SAR Image Recognition](https://arxiv.org/abs/2604.01903)
- [Efficient Convexification of Kolmogorov-Arnold Networks with Polynomial Functional Forms Via a Continuous Graham Scan Approach](https://arxiv.org/abs/2604.03871)
- [SPARK-IL: Spectral Retrieval-Augmented RAG for Knowledge-driven Deepfake Detection via Incremental Learning](https://arxiv.org/abs/2604.03833)
- [Hardware-Oriented Inference Complexity of Kolmogorov-Arnold Networks](https://arxiv.org/abs/2604.03345)
- [Non-monotonic causal discovery with Kolmogorov-Arnold Fuzzy Cognitive Maps](https://arxiv.org/abs/2604.05136)
...
- [Sharp regularity of a weighted Sobolev space over  \mathbb{T}^n  \mathbb{T}^n  and its relation to finitely differentiable KAM theory](https://arxiv.org/abs/2604.04665)
- [Interpretation of Crystal Energy Landscapes with Kolmogorov-Arnold Networks](https://arxiv.org/abs/2604.04636)
- [Hyperfastrl: Hypernetwork-based reinforcement learning for unified control of parametric chaotic PDEs](https://arxiv.org/abs/2604.06497)
- [Interpretable Clinical Classification with Kolmogorov-Arnold Networks](https://arxiv.org/abs/2509.16750)
...
- [HiPreNets: High-Precision Neural Networks through Progressive Training](https://arxiv.org/abs/2506.15064)
- [From Zero to Detail: A Progressive Spectral Decoupling Paradigm for UHD Image Restoration with New Benchmark](https://arxiv.org/abs/2604.15654)
...
- [Partition-of-Unity Gaussian Kolmogorov-Arnold Networks](https://arxiv.org/abs/2604.23599)
- [Autocorrelation Reintroduces Spectral Bias in KANs for Time Series Forecasting](https://arxiv.org/abs/2604.23518)
- [KAConvNet: Kolmogorov-Arnold Convolutional Networks for Vision Recognition](https://arxiv.org/abs/2604.23320)
...
- [SRGAN-CKAN: Expressive Super-Resolution with Nonlinear Functional Operators under Minimal Resources](https://arxiv.org/abs/2605.01459)
- [Partially Observed Structural Causal Models](https://arxiv.org/abs/2605.03268)
...
- [A Glass-Box Deep-Learning Method for Electrical Energy System Modeling Based on Kolmogorov-Arnold Network](https://arxiv.org/abs/2409.08044)
- [Neural Operators as Efficient Function Interpolators](https://arxiv.org/abs/2605.07792)
- [Towards Intelligent Low-Altitude Wireless Network Deployment: Differentiable Channel Knowledge Map Construction and Trajectory Design](https://arxiv.org/abs/2605.07163)
- [Geometric Kolmogorov--Arnold Network (GeoKAN)](https://arxiv.org/abs/2605.06740)
...
- [Posterior Contraction Rates for Sparse Kolmogorov-Arnold Networks in Anisotropic Besov Spaces](https://arxiv.org/abs/2605.11652)
- [KAN Text to Vision? The Exploration of Kolmogorov-Arnold Networks for Multi-Scale Sequence-Based Pose Animation from Sign Language Notation](https://arxiv.org/abs/2605.09572)
- [Multi-Fidelity Emulation of Atmospheric Correction Coefficients with Physics-Guided Kolmogorov-Arnold Networks](https://arxiv.org/abs/2605.10958)
...
- [Approximation Theory for Neural Networks: Old and New](https://arxiv.org/abs/2605.21451)
...
- [Physical Analogue Kolmogorov-Arnold Networks based on Reconfigurable Nonlinear-Processing Units](https://arxiv.org/abs/2602.07518)
- [K-U-KAN: Koopman-Enhanced U-KAN for 3D Dental Reconstruction from a Single Panoramic X-ray Radiograph](https://arxiv.org/abs/2605.25163)
- [SCKAN: Structural Consensus-based KAN Prototype Learning for Semi-Supervised Pancreas Segmentation](https://arxiv.org/abs/2605.27032)
- [SpCAST: Decoding spatial transcriptomics at single-cell resolution with fast and interpretable analysis](https://arxiv.org/abs/2605.26904)
- [MSCGC-KAN: Multi-scale Causal Graph Convolution and Kolmogorov-Arnold Feature Mapping for EEG Emotion Recognition](https://arxiv.org/abs/2605.26624)
...
- [Instabilities in a Non-KAM System via Information Scrambling: A Note](https://arxiv.org/abs/2606.12761)
...
- [A hybrid IFENN solver for generalizable modeling of phase-field fracture initiation and propagation](https://arxiv.org/abs/2606.27177)
- [Kolmogorov Arnold networks (KAN) for aerodynamic prediction: a comparison with MLPs and GNNs](https://arxiv.org/abs/2606.27126)
- [Low Complexity Kolmogorov-Arnold Network-based DPD for Analog RoF Fronthaul](https://arxiv.org/abs/2606.27042)
...
- [Agile Reinforcement Learning through Separable Neural Architecture and Applications](https://arxiv.org/abs/2601.23225)
- [MVG-KAN: Multi-View Geo-Wind Guided KAN for PM2.5_{2.5} Forecasting](https://arxiv.org/abs/2606.24347)
- [Sharp regularity of a weighted Sobolev space over Tn \mathbb{T}^n  and its relation to finitely differentiable KAM theory](https://arxiv.org/abs/2604.04665)
- [Quantum advantage prediction in turbulent free-space quantum illumination](https://arxiv.org/abs/2607.00308)
- [Geometry-Aware R-Structured Kolmogorov-Arnold Networks](https://arxiv.org/abs/2607.01449)
- [Particle dynamics in nonlinear electromagnetic waves: chaos onset, diffusive heating, and wave surfing](https://arxiv.org/abs/2607.04359)
...
- [Inertia-Informed Federated Learning Control Framework for Distributed Smart Grid Resilience](https://arxiv.org/abs/2607.05720)
- [Chaotic particle dynamics near a traversable wormhole throat](https://arxiv.org/abs/2607.04799)
- [KAN-LSTM-Transformer Neural Networks, MFV and Cosmological Parameters](https://arxiv.org/abs/2607.06959)
...
- [AdaKAN: A dual-branch adaptive Kolmogorov-Arnold network for medical image segmentation](https://arxiv.org/abs/2607.22891)
- [KANEx: Translating Kolmogorov-Arnold Networks' Interpretability to Medical Explainability](https://arxiv.org/abs/2607.24730)
- [Complementary Matrix-Gated QKAN Fast-Weight Programmers for Quantum Dynamics Forecasting](https://arxiv.org/abs/2607.27945)
- [Deformable Medical Image Registration with KAN-based Implicit Neural Representations](https://arxiv.org/abs/2509.22874)
...
- [Improving Fast Charging Safety With Core Temperature Estimation Via Kolmogorov-Arnold Network](https://arxiv.org/abs/2608.12638)
...
- [Kolmogorov-Arnold Networks for Spatially Independent Multispectral Land Classification](https://arxiv.org/abs/2608.13769)
- [Non-Crossing Deep Quantile Regression for Distributional Survival Prediction](https://arxiv.org/abs/2608.16864)
- [Functional anatomy of Pythia-Herwig differences with Kolmogorov-Arnold networks](https://arxiv.org/abs/2608.15952)
...
- [Interpretable Feature Learning for RF Fingerprinting via Polar MKANs](https://arxiv.org/abs/2608.19881)
- [Core-KAN: Continuous Vision Kernels with Kolmogorov-Arnold Networks](https://arxiv.org/abs/2608.19817)
- [Homoclinic Intersections and the Macroscopic Observability of Arnold Tongues in the Forced-Dissipative Duffing System](https://arxiv.org/abs/2608.19620)
- [CAT Bond Pricing with Kolmogorov--Arnold Networks](https://arxiv.org/abs/2608.19217)
...
- [MVG-KAN: Multi-View Geo-Wind Guided KAN for PM_{2.5}2.5_{2.5} Forecasting](https://arxiv.org/abs/2606.24347)
- [Scalability Analysis of Distributed Kolmogorov-Arnold Network Training on High-Performance Computing Systems](https://arxiv.org/abs/2609.07740)
- [Kolmogorov--Arnold stability for discontinuous functions](https://arxiv.org/abs/2609.07240)
- [Efficient Representation of multicategorical local Hilbert spaces: nonlinear Restricted Boltzmann Machines to Kolmogorov-Arnold Networks](https://arxiv.org/abs/2609.06672)
...
- [Inductive Biases in Field-Level Cosmological Inference from Galaxy Catalogs](https://arxiv.org/abs/2609.09504)
- [Few-sample regression with an adaptively grown variational quantum Kolmogorov--Arnold network](https://arxiv.org/abs/2503.21336)
- [Draining Fictitious Knots: Restoring Distance-Awareness Guarantees for High-Dimensional Spline Networks](https://arxiv.org/abs/2609.15274)
- [A train--prune--readout--rewrite workflow for interpretable quantum learning](https://arxiv.org/abs/2609.15139)
- [Tackling Failure Modes of PINNs and PIKANs Using Conflict-Free Gradients](https://arxiv.org/abs/2609.14841)
- [EPI-KAN: A Method For Estimating and Forecasting Time-Dependent COVID-19 Parameters](https://arxiv.org/abs/2607.15302)
